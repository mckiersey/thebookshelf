...
//Playlists
    ...
    var requestString = 'http://localhost:5555/playlists';
    ...
    $('#openPodcasts').click(function(){
        ...
        if(podcastClicker ===0){ 
            ...
            var requestString = 'http://localhost:5555/podcasts';
    ...
    // Change podcast as a function on whether it has already been picked
     ...
     $('.card-img-top-default').click(function(){
        ...
        var deletePodUrl = 'http://localhost:5555/podcasts';
        $.ajax({
            ...
            var postUrl = 'http://localhost:5555/podcasts';
    ...
    $.get(requestString, function (data, status) {
        ...
        data.forEach(function (entry) {
            ...
            document.getElementById('populateGridImages').innerHTML += `<div ${classType}>`
                ...
                + `<a class="testMe" href="http://localhost:5555/home" data-lightbox="photos"><img class="toggleImg" src="${gridImage}"></a>`
    ...
    var requestString = 'http://localhost:5555/profilePictures';
    var urlParameters = requestString + `?userName=${userName}`
    ...
    $.get(urlParameters, function (data, status) {
        ...
        profilePicFinal = "http://localhost:5555" + profilePic
...
/////////////////////////////////////////////
    ...
    $(".musicSender").off().submit(function (event) {
        ...
        var postUrl = 'http://localhost:5555/playlists'
